...
def create_training_transformations(image_path):
    ...
    augmented_dataset_1 = datasets.ImageFolder(root=dataset_path, transform=augmented_transform_1)
    augmented_dataset_2 = datasets.ImageFolder(root=dataset_path, transform=augmented_transform_2)
    augmented_dataset_3 = datasets.ImageFolder(root=dataset_path, transform=augmented_transform_3)
    original_dataset = datasets.ImageFolder(root=dataset_path, transform=original_transform)
